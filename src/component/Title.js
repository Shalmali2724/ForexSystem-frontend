  ...
  return (
    <div className="title-container">
      <div className="carousel-container">
        <Slider {...settings}>
          <div>
            <img src={process.env.PUBLIC_URL + './Images/carousel1.png'} alt="24*7 Online International Money Transfer" style={{width: '50%', height: '20%'}}/>
            <div className="point-text">24*7 Online International Money Transfer</div>
          </div>
          <div>
            <img src={process.env.PUBLIC_URL + './Images/carousel5.png '} alt="Buy & Sell Foreign Currency Notes Online at Best Rates" style={{width: '50%', height: '20%'}}/>
