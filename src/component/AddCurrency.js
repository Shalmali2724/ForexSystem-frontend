...
<TextField
             label=" Enter From Currancy" value={fromCurrency} onChange={(event)=>setFromCurrency(event.target.value)}required
        ...
        <TextField
             label=" Enter To Currancy " value={toCurrency} onChange={(event)=>setToCurrency(event.target.value)}required
...
<div className="form-group" class="col-8">
            ...
            <input style={{width:"460px",height:"50%",marginLeft:"-5%"}}
              type="date"
              name="date"
              value={date}
...
<div style={{display:"flex",justifyContent:"space-between"}}>
  ...
  <DialogActions>
   <Link to="/"><Button onClick={() => setDialogOpen(false) }>OK</Button></Link> 
  </DialogActions>
</Dialog>
